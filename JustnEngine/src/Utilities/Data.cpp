...
template<> void DataConverter::SetPrimitive <float>		(const BaseData* data, const float value)		{ ((FloatData*)data)->value = value; }
template<> void DataConverter::SetPrimitive <int>		(const BaseData* data, const int value)			{ ((IntData*)data)->value = value; }
template<> void DataConverter::SetPrimitive <uint>		(const BaseData* data, const uint value)		{ ((UIntData*)data)->value = value; }
template<> void DataConverter::SetPrimitive <bool>		(const BaseData* data, const bool value)		{ ((BoolData*)data)->value = value; }
template<> void DataConverter::SetPrimitive <glm::vec2>	(const BaseData* data, const glm::vec2 value)	{ ((Vector2Data*)data)->value = value; }
template<> void DataConverter::SetPrimitive <glm::ivec2>(const BaseData* data, const glm::ivec2 value)	{ ((Vector2iData*)data)->value = value; }
template<> void DataConverter::SetPrimitive <glm::vec3>	(const BaseData* data, const glm::vec3 value)	{ ((Vector3Data*)data)->value = value; }
